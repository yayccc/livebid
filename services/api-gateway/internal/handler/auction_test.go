...
type mockAuctionClient struct {
	...
	placeBid func(ctx context.Context, in *auctionv1.PlaceBidRequest, opts ...grpc.CallOption) (*auctionv1.PlaceBidResponse, error)
}
...
func (m mockAuctionClient) PlaceBid(ctx context.Context, in *auctionv1.PlaceBidRequest, opts ...grpc.CallOption) (*auctionv1.PlaceBidResponse, error) {
	return m.placeBid(ctx, in, opts...)
}
...
func TestAuctionHandlerCreateUsesContextShopID(t *testing.T) {
	...
	handler := NewAuctionHandler(mockAuctionClient{
		create: func(ctx context.Context, in *auctionv1.CreateAuctionRequest, opts ...grpc.CallOption) (*auctionv1.CreateAuctionResponse, error) {
			if in.GetShopId() != 1001 || in.GetGoodsId() != 2001 || in.GetRoomId() != 4001 {
	...
	body := bytes.NewBufferString(`{"goods_id":2001,"shop_id":9999,"room_id":4001,"start_price":10000,"bid_increment":1000}`)
