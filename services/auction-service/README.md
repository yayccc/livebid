...
- `AUCTION_SERVICE_GOODS_TARGET`
- `AUCTION_SERVICE_GOODS_ADDR` (legacy fallback when target is empty)
- `AUCTION_SERVICE_LIVE_TARGET`
- `AUCTION_SERVICE_LIVE_ADDR` (legacy fallback when target is empty)
- `AUCTION_SERVICE_WORKER_ID`
- `AUCTION_SERVICE_NACOS_ENABLED`
- `AUCTION_SERVICE_CONFIG_CENTER_ENABLED`
- `AUCTION_SERVICE_REGISTRY_ENABLED`
