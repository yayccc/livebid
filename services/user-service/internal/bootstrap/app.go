...
import (
	...
	"github.com/yayccc/livebid/services/user-service/internal/config"
	...
	"github.com/yayccc/livebid/services/user-service/internal/router"
	"go.uber.org/zap"
...
func New(ctx context.Context, cfg config.Config) (*App, error) {
	...
	userHandler := handler.NewUserGRPCHandler(
		userRepo,
		addressRepo,
	...
	router.RegisterGRPC(grpcServer, userHandler)
...
func (a *App) Run(ctx context.Context) error {
	...
	go func() {
		a.log.Info("user-service grpc server started", zap.String("addr", a.cfg.GRPC.Addr))
